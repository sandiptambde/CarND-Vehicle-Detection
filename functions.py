...
# convert input image to YCrCb format
...
# function to compute HOG features and visualization
def get_hog_features(img, orient, pix_per_cell, cell_per_block,
    ...
    if vis == True:
        features, hog_image = hog(img, orientations=orient,
                                  ...
                                  transform_sqrt=False,                             # Changed to False
...
# function to extract all features & create feature vectors
...
def find_cars(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            #print("hog1_features",hog_feat1.shape)
            hog_feat2 = hog2[ypos:ypos+nblocks_per_window, xpos:xpos+nblocks_per_window].ravel()
            #print("hog2_features",hog_feat2.shape)
            hog_feat3 = hog3[ypos:ypos+nblocks_per_window, xpos:xpos+nblocks_per_window].ravel()
            #print("hog3_features",hog_feat3.shape)
